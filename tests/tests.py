...
class AmityMethodBaseTestCases(unittest.TestCase):
    ...
    def test_add_person_allocates_a_person(self):
        ...
        print(self.amity.create_room('Office','Krypton'))
        self.amity.add_person("James Muratha", "Fellow")
        print(self.amity.add_person("James Muratha", "Fellow"))
    ...
    def test_reallocate_person(self):
        ...
        self.assertEqual(self.new_person.reallocate_person("Ebrahim Janoowalla", "Cotonou"),
                         [{"Ebrahim Janoowalla":"Cotonou"}])
